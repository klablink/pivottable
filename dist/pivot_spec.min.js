...
</table>`);const t=new $.pivotUtilities.PivotData(e,r);it("has the correct grand total value",()=>expect(t.getAggregator([],[]).value()).toBe(4/6))}),describe("with rows/cols",function(){const o=new $.pivotUtilities.PivotData(fixtureData,{rows:["name","colour"],cols:["trials","successes"]});it("has correctly-ordered row keys",()=>expect(o.getRowKeys()).toEqual([["Carol","yellow"],["Jane","red"],["John","blue"],["Nick","blue"]])),it("has correctly-ordered col keys",()=>expect(o.getColKeys()).toEqual([[95,25],[102,14],[103,12],[112,30]])),it("can be iterated over",function(){let e=0,t=0;for(const r of Array.from(o.getRowKeys()))for(const a of Array.from(o.getColKeys()))null!=o.getAggregator(r,a).value()?e++:t++;return expect(e).toBe(4),expect(t).toBe(12)}),it("returns matching records",function(){const t=[];return o.forEachMatchingRecord({gender:"male"},e=>t.push(e.name)),expect(t).toEqual(["Nick","John"])}),it("has a correct spot-checked aggregator",function(){var e=o.getAggregator(["Carol","yellow"],[102,14]),t=e.value();return expect(t).toBe(1),expect(e.format(t)).toBe("1")}),it("has a correct grand total aggregator",function(){var e=o.getAggregator([],[]),t=e.value();return expect(t).toBe(4),expect(e.format(t)).toBe("4")})})}),describe(".aggregatorTemplates",function(){function e(e){return new $.pivotUtilities.PivotData(fixtureData,{aggregator:e}).getAggregator([],[]).value()}const t=$.pivotUtilities.aggregatorTemplates;describe(".count",()=>it("works",()=>expect(e(t.count()())).toBe(4))),describe(".countUnique",()=>it("works",()=>expect(e(t.countUnique()(["gender"]))).toBe(2))),describe(".listUnique",()=>it("works",()=>expect(e(t.listUnique()(["gender"]))).toBe("female,male"))),describe(".average",()=>it("works",()=>expect(e(t.average()(["trials"]))).toBe(103))),describe(".sum",()=>it("works",()=>expect(e(t.sum()(["trials"]))).toBe(412))),describe(".min",()=>it("works",()=>expect(e(t.min()(["trials"]))).toBe(95))),describe(".max",()=>it("works",()=>expect(e(t.max()(["trials"]))).toBe(112))),describe(".first",()=>it("works",()=>expect(e(t.first()(["name"]))).toBe("Carol"))),describe(".last",()=>it("works",()=>expect(e(t.last()(["name"]))).toBe("Nick"))),describe(".average",()=>it("works",()=>expect(e(t.average()(["trials"]))).toBe(103))),describe(".median",()=>it("works",()=>expect(e(t.median()(["trials"]))).toBe(102.5))),describe(".quantile",()=>it("works",function(){return expect(e(t.quantile(0)(["trials"]))).toBe(95),expect(e(t.quantile(.1)(["trials"]))).toBe(98.5),expect(e(t.quantile(.25)(["trials"]))).toBe(98.5),expect(e(t.quantile(1/3)(["trials"]))).toBe(102),expect(e(t.quantile(1)(["trials"]))).toBe(112)})),describe(".var",()=>it("works",()=>expect(e(t.var()(["trials"]))).toBe(48.666666666666686))),describe(".stdev",()=>it("works",()=>expect(e(t.stdev()(["trials"]))).toBe(6.976149845485451))),describe(".sumOverSum",()=>it("works",()=>expect(e(t.sumOverSum()(["successes","trials"]))).toBe(81/412)))}),describe(".naturalSort()",function(){const e=$.pivotUtilities["naturalSort"],t=[null,NaN,-1/0,"-Infinity",-3,"-3",-2,"-2",-1,"-1",0,"2e-1",1,"01","1",2,"002","002e0","02","2","2e-0",3,10,"10","11","12","1e2","112",1/0,"Infinity","1a","2a","12a","20a","A","A","NaN","a","a","a01","a012","a02","a1","a2","a12","a12","a21","a21","b","c","d","null"];it("sorts naturally (null, NaN, numbers & numbery strings, Alphanum for text strings)",()=>expect(t.slice().sort(e)).toEqual(t))}),describe(".sortAs()",function(){const e=$.pivotUtilities["sortAs"];it("sorts with unknown values sorted at the end",()=>expect([5,2,3,4,1].sort(e([4,3,2]))).toEqual([4,3,2,1,5])),it("sorts lowercase after uppercase",()=>expect(["Ab","aA","aa","ab"].sort(e(["Ab","Aa"]))).toEqual(["Ab","ab","aa","aA"]))}),describe(".numberFormat()",function(){const t=$.pivotUtilities["numberFormat"];it("formats numbers",function(){var e=t();return expect(e(1234567.89123456)).toEqual("1,234,567.89")}),it("formats booleans",function(){var e=t();return expect(e(!0)).toEqual("1.00")}),it("formats numbers in strings",function(){var e=t();return expect(e("1234567.89123456")).toEqual("1,234,567.89")}),it("doesn't formats strings",function(){var e=t();return expect(e("hi there")).toEqual("")}),it("doesn't formats objects",function(){var e=t();return expect(e({a:1})).toEqual("")}),it("formats percentages",function(){var e=t({scaler:100,suffix:"%"});return expect(e(.12345)).toEqual("12.35%")}),it("adds separators",function(){var e=t({thousandsSep:"a",decimalSep:"b"});return expect(e(1234567.89123456)).toEqual("1a234a567b89")}),it("adds prefixes and suffixes",function(){var e=t({prefix:"a",suffix:"b"});return expect(e(1234567.89123456)).toEqual("a1,234,567.89b")}),it("scales and rounds",function(){var e=t({digitsAfterDecimal:3,scaler:1e3});return expect(e(1234567.89123456)).toEqual("1,234,567,891.235")}),describe(".date",function(){it("from date",function(){var e=t({});return expect(e(new Date("2024-01-01"),$.pivotUtilities.fieldsType.date)).toEqual("01/01/2024")}),it("from ISO string",function(){var e=t({});return expect(e(new Date("2024-01-01").toISOString(),$.pivotUtilities.fieldsType.date)).toEqual("01/01/2024")}),it("to integer",function(){var e=t({});return expect(e(10,$.pivotUtilities.fieldsType.integer)).toEqual(10)}),it("to integer",function(){var e=t({});return expect(e(10,e=>"hello_"+e)).toEqual("hello_10")})})}),describe(".derivers",function(){describe(".dateFormat()",function(){const e=$.pivotUtilities.derivers.dateFormat("x","abc % %% %%% %a %y %m %n %d %w %x %H %M %S",!0);it("formats date objects",()=>expect(e({x:new Date("2015-01-02T23:43:11Z")})).toBe("abc % %% %%% %a 2015 01 Jan 02 Fri 5 23 43 11")),it("formats input parsed by Date.parse()",function(){return expect(e({x:"2015-01-02T23:43:11Z"})).toBe("abc % %% %%% %a 2015 01 Jan 02 Fri 5 23 43 11"),expect(e({x:"bla"})).toBe("")})}),describe(".bin()",function(){const e=$.pivotUtilities.derivers.bin("x",10);it("bins numbers",function(){return expect(e({x:11})).toBe(10),expect(e({x:9})).toBe(0),expect(e({x:111})).toBe(110)}),it("bins booleans",()=>expect(e({x:!0})).toBe(0)),it("bins negative numbers",()=>expect(e({x:-12})).toBe(-10)),it("doesn't bin strings",()=>expect(e({x:"a"})).toBeNaN()),it("doesn't bin objects",()=>expect(e({x:{a:1}})).toBeNaN())})}),describe(".cellRenderers",function(){it("cellRenderers string",()=>expect($.pivotUtilities.cellRenderers.text.call({},"x").data).toBe("x")),it("cellRenderers string",()=>expect($.pivotUtilities.cellRenderers.text.call({fieldsType:{fname:$.pivotUtilities.fieldsType.date}},new Date("2024-01-01"),"fname").data).toBe("01/01/2024"))})});
