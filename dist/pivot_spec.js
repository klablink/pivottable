...
describe('$.pivotUI()', function () {
  describe('with no rows/cols, default count aggregator, default TableRenderer', function () {
    ...
    it('has all the basic UI elements', function (done) {
      expect(table.find('.pvtUiParameters .pvtAxisContainer').length).toBe(3);
      // noinspection DuplicatedCode
      expect(table.find('.pvtRendererArea').length).toBe(1);
      expect(table.find('.pvtVals').length).toBe(1);
    ...
    it('reflects its inputs', function (done) {
      expect(table.find('.pvtUiParameters .pvtUnused span.pvtAttr').length).toBe(6);
  ...
  describe('with rows/cols, sum-over-sum aggregator, Heatmap renderer', function () {
    ...
    it('reflects its inputs', function (done) {
      expect(table.find('.pvtUnused span.pvtAttr').length).toBe(4);
      expect(table.find('.pvtRows span.pvtAttr').length).toBe(1);
      expect(table.find('.pvtCols span.pvtAttr').length).toBe(1);
